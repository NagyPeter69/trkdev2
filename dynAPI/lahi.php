...
$pdf->Append();
		if( $_POST["pic"] != "" ) {
			error_log( "DEBUG: név: ".$_POST["first_name"]." ".$_POST["last_name"]." | pic: ".$_POST["filename"]." , ".$_POST["pic_ext"] );
			$pdf->BeginLayer($o.c2);
			$pdf->SetColorSpace( 1 );
			...
			$pdf->InsertImageEx( coord(34.43 +$corr1x), coord(-2 +$corr1y), coord(67.13 +$corr1x), 0, "raw_img.".$_POST["pic_ext"], 1 );
			$pdf->EndLayer();
			}
...
$pdf->EndPage();
$pdf->CloseImportFile();
$pdf->RenderPageToImage(1, "rendered/".$_POST["filename"].".png", 200, 0, 0, dynapdf::rfDefault, dynapdf::pxfRGB, dynapdf::cfFlate, dynapdf::ifmJPEG);
$pdf->CloseFile();
