...
$pdf->Append();
	...
	if( $_POST["user_type"] != "5" ) {
		if( $_POST["pic"] != "" ) {
			...
			$pdf->InsertImageEx( coord(129 +$corr1x), coord(-2 +$corr1y), coord(67.131 +$corr1x), 0, "raw_img.".$safePicExt, 1 );
			$pdf->EndLayer();
			}
		...
		if( $_POST["pic"] != "" ) {
			...
			$pdf->SetPageCoords(dynapdf::pcBottomUp);	
			$pdf->InsertImageEx( coord(129 +$corr1x), coord(-2+$corr1y), coord(67.131 +$corr1x), 0, "raw_2img.".$safePicExt, 1 );
			$pdf->EndLayer();
			}	
		}
	...
	if( $_POST["user_type"] == "5" ) {	
		if( $_POST["pic"] != "" ) {
			...
			$pdf->SetPageCoords(dynapdf::pcBottomUp);
			$pdf->InsertImageEx( coord(115 +$corr1x), coord(-2 +$corr1y), coord(67.131 +$corr1x), 0, "raw_img.".$safePicExt, 1 );
			$pdf->EndLayer();
			}
		...
		if( $_POST["pic"] != "" ) {
			...
			file_put_contents( "raw_2img.".$safePicExt, $_POST["pic"] );
			$pdf->SetPageCoords(dynapdf::pcBottomUp);	
			$pdf->InsertImageEx( coord(115 +$corr1x), coord(-2+$corr1y), coord(67.131 +$corr1x), 0, "raw_2img.".$safePicExt, 1 );
			$pdf->EndLayer();
			}
		}
