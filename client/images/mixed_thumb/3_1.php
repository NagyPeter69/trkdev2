...
<rect class="mix_field" boxplace="left" place="fullwidth" x="12" y="83" style="fill:#'.$mpages[2]["color"].';" width="95" height="65"/>
</svg>';

$txt .= '<div class="svgdotbox" style="right: 43px; bottom: 52px; width: 35px;">'.$mpages[0]["dots"].'</div>';
$txt .= '<div class="svgdotbox" style="right: 9px; bottom: 4px; width: 35px;">'.$mpages[1]["dots"].'</div>';
$txt .= '<div class="svgdotbox" style="right: 9px; bottom: 52px; width: 35px;">'.$mpages[2]["dots"].'</div>';
