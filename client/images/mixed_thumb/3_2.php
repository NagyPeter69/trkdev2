...
<rect class="mix_field" boxplace="left" place="left" x="12" y="83" style="fill:#'.$mpages[1]["color"].';" width="45" height="65"/>
<rect class="mix_field" boxplace="right" place="right" x="62" y="83" style="fill:#'.$mpages[2]["color"].';" width="45" height="65"/>
</svg>';

$txt .= '<div class="svgdotbox" style="right: 9px; bottom: 52px; width: 35px;">'.$mpages[0]["dots"].'</div>';
...
$txt .= '<div class="svgworkerbox" style="right: -4px; top: 3px; width: 19px;">'.$mpages[0]["worker"].'</div>';
$txt .= '<div class="svgworkerbox" style="left: 32px; top: 49px; width: 19px;">'.$mpages[1]["worker"].'</div>';
$txt .= '<div class="svgworkerbox" style="right: -4px; top: 49px; width: 19px;">'.$mpages[2]["worker"].'</div>';
