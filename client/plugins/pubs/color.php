...
function newLine() {
	...
	<?php } else { ?>
		...
		?>
		<?php if( $newxml->Item[$x]->PageNumbering == "European" ) { ?>
		text += '</select></span><span style="padding-left: 5px;">'+posname+': <input type="text" onkeydown="numberCheck3(event)" name="position[]" style="width: 100px;"></span><span style="padding-left: 10px;"><?= $lang["parts"]["Trimmed"] ?>: <input type="text" name="trim_x[]" style="width: 35px;"> x <input type="text" name="trim_y[]" style="width: 35px;"> mm</span><span style="padding-left: 10px; <?= ( $newxml->Item[$x]->PDFstandard == "Web" ? "display: none;" : "" ) ?>"><?= $lang["parts"]["Color"] ?>: <select name="color[]"><option value="FOGRA_29">FOGRA 29</option><option selected value="FOGRA_39">FOGRA 39</option><option value="FOGRA_41">FOGRA 41</option><option value="FOGRA_45">FOGRA 45</option><option value="FOGRA_46">FOGRA 46</option><option value="FOGRA_47">FOGRA 47</option><option value="FOGRA_48">FOGRA 48</option><option value="FOGRA_51">FOGRA 51</option><option value="FOGRA_52">FOGRA 52</option><option value="IFRA_26">IFRA 26</option><option <?= ( $newxml->Item[$x]->PDFstandard == "Web" ? "selected" : "" ) ?> value="RGB">RGB</option></select></span><span style="padding-left: 5px;"><img onclick="removeRow( $(this) )" src="images/trash.png" style="cursor: pointer; height: 14px;"></span></td></tr>';
		<?php } else { ?>
		text += '</select></span><span style="padding-left: 10px;"><?= $lang["parts"]["Trimmed"] ?>: <input type="text" name="trim_x[]" style="width: 35px;"> x <input type="text" name="trim_y[]" style="width: 35px;"> mm</span><span style="padding-left: 10px; <?= ( $newxml->Item[$x]->PDFstandard == "Web" ? "display: none;" : "" ) ?>"><?= $lang["parts"]["Color"] ?>: <select name="color[]"><option value="FOGRA_29">FOGRA 29</option><option selected value="FOGRA_39">FOGRA 39</option><option value="FOGRA_41">FOGRA 41</option><option value="FOGRA_45">FOGRA 45</option><option value="FOGRA_46">FOGRA 46</option><option value="FOGRA_47">FOGRA 47</option><option value="FOGRA_48">FOGRA 48</option><option value="FOGRA_51">FOGRA 51</option><option value="FOGRA_52">FOGRA 52</option><option value="IFRA_26">IFRA 26</option><option <?= ( $newxml->Item[$x]->PDFstandard == "Web" ? "selected" : "" ) ?> value="RGB">RGB</option></select></span><span style="padding-left: 5px;"><img onclick="removeRow( $(this) )" src="images/trash.png" style="cursor: pointer; height: 14px;"></span></td></tr>';		
		<?php } ?>
	<? } ?>
