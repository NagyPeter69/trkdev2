...
// sub== handlers checked authentication before running, despite recording
// $user[0][0] as the creator of the hotlink/handout link they send. Same
// fix: one gate before any sub is dispatched.
if( empty( $user[0][0] ) ) {
